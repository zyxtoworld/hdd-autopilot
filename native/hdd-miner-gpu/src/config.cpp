...
Config default_config(std::size_t batch_size) {
    return Config{
        ...
        .invite_output_file = resolve_data_file_path("log/mining/system/invite-codes.txt"),
        .balance_output_file = resolve_data_file_path("log/mining/system/balance-codes.txt"),

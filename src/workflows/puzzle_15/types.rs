...
pub(super) struct Puzzle15RoundSummary {
...
#[derive(Debug, Clone, PartialEq, Default)]
pub(super) struct Puzzle15DifficultySummary {
    pub(super) email: String,
    pub(super) difficulty: String,
...
#[derive(Debug, Clone, PartialEq, Default)]
pub(super) struct Puzzle15Snapshot {
    pub(super) board: Vec<i32>,
    pub(super) difficulty: String,
    pub(super) session_id: i32,
    pub(super) size: i32,
    pub(super) move_count: i32,
    pub(super) scramble: i32,
    pub(super) status: String,
    pub(super) won: bool,
